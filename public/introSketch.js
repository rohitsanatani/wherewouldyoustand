...
function draw()
{
    ...
    textAlign(CENTER);
    text("When was the last time you walked into a crowded subway coach and \n lost a seat to someone who was more strategically positioned? \n\n Well, turns out, we seldom make the most rational decisions in this regard.", width/2, 0.2*height);
    text("Play this quick game to find out why, and how predictable your intuitive decisions are!\n \n Hit 'ENTER' to proceed", width/2, 0.75*height);
